...
# ---------------------------------------------------------------- G2 Q.MI / AC Module / ACCB
# Imported from the G2 AC module, microinverter & AC combiner DNV Technology Review
# workbook (Aug 2026). Section titles and owners come from the real worksheet tabs:
# that workbook's "00 DNV Master Index" still carries the G4-ESS section names and
# #REF! counts, and lists 6 sections where the workbook actually has 9.
SRC_G2 = "https://docs.google.com/spreadsheets/d/1pjEoEttYuZ5g_wvRRju3wf-CFnQhFaNBcN846SSsyBM/edit"

G2_ACM_SECTIONS = [('01 Company Eval',
  '1. Company and Business Evaluation',
  'CE / MKTG',
  [{'item_id': '1.1',
    'sub_section': 'Company Overview',
    'review_item': 'Corporate documentation required',
    'evidence': 'Company History; Organization and global business footprint; Business Portfolio; '
                'EPEAT; R&D capabilities; (Corporate drafted documentation)',
    'suggested_owner': 'Sarah O. / Legal / RBO / MKTG',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '1.2',
    'sub_section': 'Company financial and sales revenue',
    'review_item': 'Corporate documentation required',
    'evidence': 'Manufacturing investments; Market Cap; Profitability; Historical PV module '
                'growth; Historical MI/ACM growth; Historical ESS growth; Charts; (Corporate '
                'drafted documentation)',
    'suggested_owner': 'RBO / Legal',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '1.3',
    'sub_section': 'Product History',
    'review_item': 'Product History',
    'evidence': 'Product history; Install base; Operating years; Markets/customers; Patents; '
                'Capacity plan',
    'suggested_owner': 'PO planning / CS&E',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '1.4',
    'sub_section': 'Company Evaluation',
    'review_item': 'Product Images',
    'evidence': 'Stand-alone microinverters - front, angled; AC combiner - front',
    'suggested_owner': 'MKTG',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('02 System Overview',
  '2. System Overview',
  'CE / Product PM',
  [{'item_id': '2.1',
    'sub_section': 'System Overview',
    'review_item': 'Description of system',
    'evidence': 'Product Manual; App notes',
    'suggested_owner': 'CE',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '2..2',
    'sub_section': 'System Diagrams',
    'review_item': 'AC module system diagram',
    'evidence': 'Drawing of full ACM system',
    'suggested_owner': 'MKTG',
    'priority': 'Low',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '2.3',
    'sub_section': 'BOS components',
    'review_item': 'Description of cables/end caps/brackets',
    'evidence': 'drawings; datasheets; certifications',
    'suggested_owner': 'DevPM / CE',
    'priority': 'Low',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '2.4',
    'sub_section': 'Monitoring',
    'review_item': 'Description of Q.OMMAND',
    'evidence': 'Commissioning manual; Screenshots; Data granularity',
    'suggested_owner': 'CE',
    'priority': 'Low',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '2.5',
    'sub_section': 'Fleet Management',
    'review_item': 'Description of Fleet manager',
    'evidence': 'API; Screenshots; features',
    'suggested_owner': 'SWPM / CE',
    'priority': 'Low',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('03 PV Tech Eval',
  '3. PV Module Technical Evaluation',
  'CE / Product PM',
  [{'item_id': '3.1',
    'sub_section': 'PV module review (PERC & TOPCon)',
    'review_item': 'Module Review',
    'evidence': 'Datasheet',
    'suggested_owner': 'PVE',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.2',
    'sub_section': 'PV module overview (PERC & TOPCon)',
    'review_item': 'Module Review',
    'evidence': 'contact description; Backsheet description; Backsheet testing; Cut-cell '
                'description; Cut-cell field data and/or comprehensive extended duration test '
                'results (industry or intternal evidence). Not required.',
    'suggested_owner': 'PVE',
    'priority': 'Low',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.3',
    'sub_section': 'PV module overview (PERC & TOPCon)',
    'review_item': 'BOM review',
    'evidence': 'High-level BOM summary (not to be published); Supplier sources',
    'suggested_owner': 'PVE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.4',
    'sub_section': 'PV module overview (PERC & TOPCon)',
    'review_item': 'DC module ALT Testing',
    'evidence': 'Test plans, passing conditions, results:; Thermal Cycle; Damp Heat; PID; LeTID; '
                'Static Mech load',
    'suggested_owner': 'PVE',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('04 ACM Tech Eval',
  '4. AC Module Technical Evaluation',
  'CE / Product PM',
  [{'item_id': '4.1',
    'sub_section': 'AC Module Review',
    'review_item': 'AC Module review',
    'evidence': 'Thermal gap; effect of MI on module backsheet; Lessons learned',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '4.2',
    'sub_section': 'AC Module Review',
    'review_item': 'MI-module connection',
    'evidence': 'Description of adhesion/connection; Pull-force tests',
    'suggested_owner': 'SQT',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '4.3',
    'sub_section': 'Thermal performance',
    'review_item': 'Eumsung Testing',
    'evidence': 'Testing ACM vs add-on w/ thermal monitoring',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('05 MI Tech Eval',
  '5. Microinverter Technical Evaluation',
  'CE / Product PM',
  [{'item_id': '5.1',
    'sub_section': 'Microinverter Review',
    'review_item': 'Microinverter History',
    'evidence': "Qcells' MI/ACM history; Lessons learned from previous generations; Benefits of MI "
                'performance',
    'suggested_owner': 'Dev. PM / CE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.2',
    'sub_section': 'Microinverter topology',
    'review_item': 'Block diagram',
    'evidence': 'Architectural diagram',
    'suggested_owner': 'Dev. Eng / CE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.6',
    'sub_section': 'Microinverter topology',
    'review_item': 'Maximum Power point tracking',
    'evidence': 'Description of the MPPT algorythm; MPPT graphs; Static and Dynamic MPPT test '
                'results / graphs',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   ...
   {'item_id': '5.4',
    'sub_section': 'Technical Specifications',
    'review_item': 'Environmental Characteristics',
    'evidence': 'Thermal characteristics; Thermal derating; Graphs',
    'suggested_owner': 'Dev. PM',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.5',
    'sub_section': 'Product Efficiency',
    'review_item': 'Efficiency Testing',
    'evidence': 'CEC Efficientcy tests; Static efficiency; Dynamic Efficiency; Drawing',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.7',
    'sub_section': 'Power Quality and Grid support',
    'review_item': 'Evidence of safe operation on grid',
    'evidence': 'Certifications; Anti-islanding method; FCC conformance letter; THD test data; '
                'Available grid profiles',
    'suggested_owner': 'Dev. Eng / CE',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.8',
    'sub_section': 'Design for Reliability',
    'review_item': 'Reliability models',
    'evidence': 'MTBF reports; DFMEA; FMEA',
    'suggested_owner': 'SQT',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.9',
    'sub_section': 'Product Reliability Testing',
    'review_item': 'Reliability Test plan/results',
    'evidence': '3rd party test plan/results; ENV test plan/results; ALT test plan/results',
    'suggested_owner': 'Dev. Eng / SQT',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.10',
    'sub_section': 'Regualtory',
    'review_item': 'Product certifications',
    'evidence': 'UL 1741; UL 3141; IEEE 2030.5; FCC 15 part B',
    'suggested_owner': 'Dev. Eng',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('06 AC Combiner Tech Eval',
  '6. AC Combiner Technical Evaluation',
  'CE / Product PM',
  [{'item_id': '3.1',
    'sub_section': 'AC Combiner Overview',
    'review_item': 'Description of the AC combiner',
    'evidence': 'What has changed; Consumption monmitoring single-lines',
    'suggested_owner': 'Dev. PM / CE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.2',
    'sub_section': 'AC Combiner Overview',
    'review_item': 'AC Combiner History',
    'evidence': 'Lessons learned from previous generations; Benefits of MI performance',
    'suggested_owner': 'Dev. PM / CE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.3',
    'sub_section': 'AC Combiner Overview',
    'review_item': 'Architecture',
    'evidence': 'Block Diagram',
    'suggested_owner': 'Dev. PM',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.1',
    'sub_section': 'AC Combiner Technical Specs',
    'review_item': 'Datasheet',
    'evidence': 'Datasheet',
    'suggested_owner': 'Dev. PM / CE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.4',
    'sub_section': 'AC Combiner Environmental Characteristics',
    'review_item': 'ENV Test Plan/results',
    'evidence': 'Damp Heat; Humidity Freeze; Conformal coating',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.5',
    'sub_section': 'AC Combiner Evaluation',
    'review_item': 'ALT test plan/results',
    'evidence': 'Hi-pot; High Temp; Heat/humidity; Power/temp cycling',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '3.1',
    'sub_section': 'AC Combiner Certification',
    'review_item': 'Certification',
    'evidence': 'UL 1741SB; UL 3141; IEEE 2030.5; FCC 15 Part B + FCC comformance letter; RGM ANSI '
                'cert',
    'suggested_owner': 'Dev. Eng',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('07 PV MFG Eval',
  '7. PV / ACM Manufacturing Evaluation',
  'QLTY',
  [{'item_id': '4.1',
    'sub_section': 'Dalton Manufacturing Factory Visit',
    'review_item': 'Factory Visit and overview',
    'evidence': 'Factory Visit,; Production Capacity; ISO 9001, 14001, ISO 45001 certs',
    'suggested_owner': 'SQT / CE',
    'priority': 'Medium',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '4.3',
    'sub_section': 'Dalton Incoming Materials management',
    'review_item': 'Warehouse Evaluation',
    'evidence': 'Storage locations; Principals and methodology; Inventory Control documents; '
                'Material inspection documentation; Out of Control Action Plan; testing '
                'capabilities',
    'suggested_owner': 'SQT',
    'priority': 'Low',
    'source': ''},
   {'item_id': '4.2',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Production process Overview',
    'evidence': 'Manufacturing Overview; Process diagram; SOPs; Calibration and maintenence '
                'documents; Summary of automation',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Production Planning',
    'evidence': 'Planning SW used; Production planning document',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.4',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Manufacturing process',
    'evidence': 'Manufacturing overview; Production line diagrams; Automated lines',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.6',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Process controls',
    'evidence': 'In-process Quality Controls',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.7',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Equipment Management',
    'evidence': 'Equipment maintenence plan and historical records; calibration records; '
                'preventative maintenence records',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.8',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Manufacturing Execution System',
    'evidence': 'Description of MES tracability',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.9',
    'sub_section': 'Dalton Production Process',
    'review_item': 'Non-confirmance management',
    'evidence': 'Rework process, definition of non-conformances',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.10',
    'sub_section': 'Dalton Quality Management',
    'review_item': 'Quality management system description',
    'evidence': 'Define quality management techniques (Statistical Process Control, Total Quality '
                'Management, Cost of Quality, or six Sigma methodology)',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.11',
    'sub_section': 'Dalton Quality Management',
    'review_item': 'Quality management tools',
    'evidence': 'Description of Information systems; change control management; operator training; '
                'SOPS; on-going product testing program',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.12',
    'sub_section': 'Dalton Quality Management',
    'review_item': 'Supplier qualification process',
    'evidence': 'Supplier qualification requirements; Supplier Audit reports; Corrective Action '
                'reports; PFMEA',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.13',
    'sub_section': 'Dalton Off-Line testing capabilities',
    'review_item': 'In-house Testing capability',
    'evidence': 'List in-house testing capabilties IQC/IPQC',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.14',
    'sub_section': 'Dalton Quality Management',
    'review_item': 'Ongoing reliability testing',
    'evidence': 'Describe; QCPV test plan; sample qty; test location; test program diagram',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.15',
    'sub_section': 'Employee management',
    'review_item': 'Factory organization',
    'evidence': 'Org chart; # of employees; training records; safety plan/manual; emergency action '
                'plan, first and medical aid, and chemical safety.',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.16',
    'sub_section': 'Return Merchandise Agreement',
    'review_item': 'RMA proceedures',
    'evidence': 'RMA procedures documents; RMA case example; 8D report; resolution and '
                'product/process improvements',
    'suggested_owner': 'SQT',
    'priority': 'Medium',
    'source': ''}]),
 ('08 Inverter Manufacturing Evalu',
  '8. Inverter Manufacturing Evaluation',
  'QLTY',
  [{'item_id': '4.1',
    'sub_section': 'Inverter Manufacturing Factory Visit',
    'review_item': 'Factory Overview, site visit',
    'evidence': 'Factory Visit; # of employees; org chart of roles; training records; safety '
                'plan/manual, emergency action plan, first and medical aid, and chemical safety; '
                'location, size; production capacity',
    'suggested_owner': 'SQT / CE',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '',
    'sub_section': 'Inverter Manufacturing Factory Visit',
    'review_item': 'Inverter Manufacturing Quality',
    'evidence': 'ISO 9001, 14001, 5001,; UL audit report',
    'suggested_owner': '',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '4.2',
    'sub_section': 'Inverter Manufacturing Process',
    'review_item': 'Supply chain',
    'evidence': 'Supply chain requirements and vendor management',
    'suggested_owner': 'SQT',
    'priority': 'High',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Inverter Manufacturing Process',
    'review_item': 'Incoming Materials Inspection',
    'evidence': 'Material inspection documentation; Out of Control Action Plan, testing '
                'capabilities',
    'suggested_owner': 'SQT',
    'priority': 'High',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Inverter Manufacturing Process',
    'review_item': 'System assembly',
    'evidence': 'Manufacturing description of each station; Process diagram; Description of MES '
                'tracability',
    'suggested_owner': 'SQT',
    'priority': 'High',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Inverter Manufacturing Process',
    'review_item': 'Testing`',
    'evidence': 'Test plan, method and criteria; ICT, Function Tests, Hi-Pot, Aging tests, etc.',
    'suggested_owner': '',
    'priority': 'High',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Inverter Manufacturing Process',
    'review_item': 'Shipping and Packaging',
    'evidence': 'Packaging BOM and drawings; Packaging process; #/box, box/pallet',
    'suggested_owner': '',
    'priority': 'Low',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Inverter Manufacturing Process',
    'review_item': 'Ongoing reliability testing',
    'evidence': 'Ongoing reliability test plan; Diagram',
    'suggested_owner': '',
    'priority': 'Medium',
    'source': ''},
   {'item_id': '',
    ...
    'source': ''},
   {'item_id': '',
    'sub_section': 'Quality Management',
    'review_item': 'Quality management tools',
    'evidence': 'Description of Information systems; change control management; operator training; '
                'SOPS; on-going product testing program',
    'suggested_owner': '',
   ...
   {'item_id': '',
    ...
    'source': ''},
   {'item_id': '',
    'sub_section': 'Off-line testing',
    'review_item': 'In-house Testing capability',
    'evidence': 'List in-house testing capabilties',
    'suggested_owner': '',
    'priority': 'High',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Off-line testing',
    'review_item': 'Ongoing reliability testing',
    'evidence': 'QCPV test plan, sample qty, test location, test program diagram',
    'suggested_owner': '',
    'priority': 'High',
    'source': ''},
   {'item_id': '5.8',
    'sub_section': 'Microinverter Review',
    'review_item': 'Quality Systems',
    'evidence': 'ISO 9001, ISO 14001, ISO 45001 (and any others); Quality Assurance org; Quality '
                'Management System requirements; QA process; Continuous improvement model',
    'suggested_owner': 'SQT',
    'priority': 'Low',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '5.10',
    'sub_section': 'Microinverter Review',
    'review_item': 'Root Cause Analysis',
    'evidence': 'RCAs for different types of failures',
    'suggested_owner': 'CS&E',
    'priority': 'High',
    'source': 'G2 ACM & AC combiner DNV report (2026)'}]),
 ('09 Product Support',
  '9. Product Support, Service and Warranty',
  'CS&E',
  [{'item_id': '',
    'sub_section': 'Service Infrastructure',
    'review_item': 'Service Infrastructure Evaluation',
    'evidence': 'Description - what we do; Purpose; Support Tiers; Contact methods; RMA process',
    'suggested_owner': 'CS&E',
    'priority': 'High',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Service Infrastructure',
    'review_item': 'Warranty Evaluation',
    'evidence': 'Limited Warranty coverage; Warranty Inclusions; Key Exclusions and Conditions; '
                'Transferability',
    'suggested_owner': 'CS&E / SP',
    'priority': 'Critical',
    'source': ''},
   {'item_id': '',
    'sub_section': 'Service Infrastructure',
    'review_item': 'Product Documentation',
    'evidence': 'Where can it be found?; Datasheets; Manuals; Application notes; FAQs',
    'suggested_owner': 'Dev. PM',
    'priority': 'Critical',
    'source': ''},
   {'item_id': '5.9',
    'sub_section': 'Microinverter Review',
    'review_item': 'Microinverter Field History',
    'evidence': 'Population size; Duration of operation; Failures; Documentation and lessons '
                'learned; Monthly Installation by sites; Monthly installation by product qty; '
                'Failure rate; Failure types',
    'suggested_owner': 'CS&E',
    'priority': 'Critical',
    'source': 'G2 ACM & AC combiner DNV report (2026)'},
   {'item_id': '',
    'sub_section': 'AC Combiner Review',
    'review_item': 'AC Combiner Field History',
    'evidence': 'Population size; Duration of operation; Failures; Documentation and lessons '
                'learned; Monthly Installation by sites; Monthly installation by product qty; '
                'Failure rate; Failure types',
    'suggested_owner': 'CS&E',
...
BASELINE_G2 = {
    "name": "DNV AC Module / Microinverter Technology Review (G2 baseline)",
    "reviewer": "DNV",
    "category": "AC Module",
    "notes": "Imported from the G2 Q.MI / AC Module / ACCB DNV Technology Review workbook, Aug 2026.",
    "source_url": SRC_G2,
    "sections": G2_ACM_SECTIONS,
}

BASELINE_G4["source_url"] = SRC

# Every baseline template shipped with the app.
BASELINES = [BASELINE_G4, BASELINE_G2]
